...
def test_simulate_temperature_returns_tuple():
    ...
    L = 4
    T = 2.0
    result = simulate_single_temperature(L, T, n_equilibration=10, n_measurements=10)
...
def test_simulate_temperature_unpacking():
    ...
    L = 4
    T = 2.5
    e, m, C, chi = simulate_single_temperature(L, T, n_equilibration=10, n_measurements=10)
...
def test_simulate_temperature_magnetization_bounds():
    ...
    L = 8
    T = 2.0
    e, m, C, chi = simulate_single_temperature(L, T, n_equilibration=20, n_measurements=20)
...
def test_simulate_temperature_energy_bounds():
    ...
    J = 1.0
    h = 0.0
    e, m, C, chi = simulate_single_temperature(L, T, n_equilibration=20, n_measurements=20, J=J, h=h)
...
def test_simulate_temperature_high_temperature():
    ...
    e, m, C, chi = simulate_single_temperature(L, T, n_equilibration=50, n_measurements=50)
...
def test_simulate_temperature_with_external_field():
    ...
    e, m, C, chi = simulate_single_temperature(L, T, n_equilibration=20, n_measurements=20, h=h)
...
def test_simulate_temperature_minimal_parameters():
    ...
    result = simulate_single_temperature(L, T, n_equilibration=1, n_measurements=1)
...
def test_simulate_temperature_susceptibility_peak_location():
    ...
    _, _, _, chi_below = simulate_single_temperature(L, T_below, n_equilibration=10000, n_measurements=1000)
    _, _, _, chi_at = simulate_single_temperature(L, T_at, n_equilibration=10000, n_measurements=1000)
    _, _, _, chi_above = simulate_single_temperature(L, T_above, n_equilibration=10000, n_measurements=1000)
