...
plt.savefig('ising_aimantation stabilisée-critère 500 pas.pdf', bbox_inches='tight')
plt.show()
...
plt.title("Evolution de l'Aimantation pour différentes températures sur 500 pas de Monte Carlo")
plt.savefig("Evolution de l'aimentation-critère 500 pas.pdf", format="pdf",bbox_inches='tight')
plt.show()